...
function hue$1(a, b) {
  var d = b - a;
  return d ? linear$3(a, d > 180 || d < -180 ? d - 360 * Math.round(d / 360) : d) : constant$3(isNaN(a) ? b : a);
}
...
cubehelixLong$1(cubehelix$3(300, 0.5, 0.0), cubehelix$3(-240, 0.5, 1.0));

var warm = cubehelixLong$1(cubehelix$3(-100, 0.75, 0.35), cubehelix$3(80, 1.50, 0.8));

var cool = cubehelixLong$1(cubehelix$3(260, 0.75, 0.35), cubehelix$3(80, 1.50, 0.8));
...
function basis$4(t1, v0, v1, v2, v3) {
  var t2 = t1 * t1, t3 = t2 * t1;
  return ((1 - 3 * t1 + 3 * t2 - t3) * v0
      + (4 - 6 * t2 + 3 * t3) * v1
      + (1 + 3 * t1 + 3 * t2 - 3 * t3) * v2
...
var basis$5 = function(values) {
  ...
  return function(t) {
    ...
    return basis$4((t - i / n) * n, v0, v1, v2, v3);
  };
};
...
function hue$2(a, b) {
  var d = b - a;
  return d ? linear$4(a, d > 180 || d < -180 ? d - 360 * Math.round(d / 360) : d) : constant$5(isNaN(a) ? b : a);
}

function gamma$2(y) {
  return (y = +y) === 1 ? nogamma$2 : function(a, b) {
    return b - a ? exponential$2(a, b, y) : constant$5(isNaN(a) ? b : a);
  };
}

function nogamma$2(a, b) {
  var d = b - a;
  return d ? linear$4(a, d) : constant$5(isNaN(a) ? b : a);
}
...
var rgbBasis$2 = rgbSpline$2(basis$5);

var number$3 = function(a, b) {
  return a = +a, b -= a, function(t) {
    return a + b * t;
  };
};
...
var ramp$1 = function(scheme) {
  return rgbBasis$2(scheme[scheme.length - 1]);
};
...
var reRgbInteger$3 = new RegExp("^rgb\\(" + [reI$3, reI$3, reI$3] + "\\)$");
var reRgbPercent$3 = new RegExp("^rgb\\(" + [reP$3, reP$3, reP$3] + "\\)$");
var reRgbaInteger$3 = new RegExp("^rgba\\(" + [reI$3, reI$3, reI$3, reN$3] + "\\)$");
var reRgbaPercent$3 = new RegExp("^rgba\\(" + [reP$3, reP$3, reP$3, reN$3] + "\\)$");
var reHslPercent$3 = new RegExp("^hsl\\(" + [reN$3, reP$3, reP$3] + "\\)$");
var reHslaPercent$3 = new RegExp("^hsla\\(" + [reN$3, reP$3, reP$3, reN$3] + "\\)$");
...
define$3(Rgb$3, rgb$5, extend$3(Color$3, {
  brighter: function(k) {
...
define$3(Lab$3, lab$6, extend$3(Color$3, {
  ...
  rgb: function() {
    ...
    z = Zn$3 * lab2xyz$3(z);
    return new Rgb$3(
      xyz2rgb$3( 3.2404542 * x - 1.5371385 * y - 0.4985314 * z), // D65 -> sRGB
      xyz2rgb$3(-0.9692660 * x + 1.8760108 * y + 0.0415560 * z),
      xyz2rgb$3( 0.0556434 * x - 0.2040259 * y + 1.0572252 * z),
      this.opacity
    );
  }
}));
...
function basis$6(t1, v0, v1, v2, v3) {
  var t2 = t1 * t1, t3 = t2 * t1;
  return ((1 - 3 * t1 + 3 * t2 - t3) * v0
      + (4 - 6 * t2 + 3 * t3) * v1
      + (1 + 3 * t1 + 3 * t2 - 3 * t3) * v2
...
function hue$3(a, b) {
  var d = b - a;
  return d ? linear$5(a, d > 180 || d < -180 ? d - 360 * Math.round(d / 360) : d) : constant$6(isNaN(a) ? b : a);
}

function gamma$3(y) {
  return (y = +y) === 1 ? nogamma$3 : function(a, b) {
    return b - a ? exponential$3(a, b, y) : constant$6(isNaN(a) ? b : a);
  };
}

function nogamma$3(a, b) {
  var d = b - a;
  return d ? linear$5(a, d) : constant$6(isNaN(a) ? b : a);
}
...
function parseSvg$3(value) {
  ...
  if (!(value = svgNode$3.transform.baseVal.consolidate())) return identity$6;
  value = value.matrix;
...
var interpolate$1 = function(a, b) {
  ...
  return (typeof b === "number" ? interpolateNumber$1
      : b instanceof color$3 ? interpolateRgb$1
      : (c = color$3(b)) ? (b = c, interpolateRgb$1)
...
var transition_attr$1 = function(name, value) {
  var fullname = namespace(name), i = fullname === "transform" ? interpolateTransformSvg$3 : interpolate$1;
  return this.attrTween(name, typeof value === "function"
...
function onFunction$1(id, name, listener) {
  var on0, on1, sit = start$1(name) ? init$1 : set$6;
  return function() {
    var schedule = sit(this, id),
        on = schedule.on;
...
var transition_style$1 = function(name, value, priority) {
  var i = (name += "") === "transform" ? interpolateTransformCss$3 : interpolate$1;
  return value == null ? this
